...
<main id="main" class="main">
            ...
            <div class="row">
                <div class="col-lg-11">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Data Hasil AHP pada Tanah Basah</h3>
                        </div>
                        <div class="card-body">
                            <div class="card-body table-responsive p-0" style="height: 300px;">
                                ...
                                <table id="example2" class="table table-bordered table-hover table-head-fixed">
                                    ...
                                    <tbody>
                                        @foreach($rankingBasah as $index => $item)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
    ...
    <div class="col-lg-11">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Bar Chart AHP Tanah Basah</h5>
                ...
                @php
                    session(['rankingBasah' => $rankingBasah]);
                    @endphp
