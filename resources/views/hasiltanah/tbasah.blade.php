                ...
                <div class="col-lg-11">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="card-title">Data Hasil Sensor pada Tanah Basah</h2>
                            <div class="float-right">
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="faqsTwo-1" class="accordion-collapse collapse" data-bs-parent="#faq-group-2" style="">
                                                    <div class="accordion-body">
                                                        ...
                                                        Rentang pH tanah yang umumnya dianggap ideal adalah antara 6,0 hingga 7,0 untuk sebagian besar tanaman, rentang kelembaban tanah 
                                                        yang dianggap ideal adalah sekitar 50% hingga 75%, suhu udara antara 20°C hingga 25°C, suhu tanah antara 18°C hingga 24°C. nilai-nilai 
                                ...
                                <form action="{{ route('tbasah.deleteAll') }}" method="POST">
                                    @csrf
